    ...
    computed: {
        generateMenus() {
            return [
                ...
                // if you use link (:to) for external url, it will be like http://localhost:8080/https://twitter.com/airaniiofifteen
                ...
                { 
                    ...
                    url: 'https://twitter.com/airaniiofifteen',
                    target: '_blank',
                ...
                { 
                    ...
                    url: 'https://streamlabs.com/airaniiofifteenchannelhololive-id/tip',
                    target: '_blank',
